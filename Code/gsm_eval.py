...
MAX_LENGTH = 512
threshold = 0.5 # 0.9725 is a good one
...
if __name__ == "__main__":
    ...
    # df8 = pd.read_csv("/home/tmalik6/LLMR/Code/GSM_Symbolic/CSVs_latest/P1_L70_L8_Ge_baselines_full.csv") 
    df8 = pd.read_csv("/home/tmalik6/LLMR/Code/GSM_Symbolic/CSVs_latest/P2_L70_L8_Ge_baselines_full.csv") 

    l8_full = df8["L8 Full"].to_list()
    l70_full = df8["L70 Full"].to_list()

    Answers = df8["Correct Answer"].to_list()
    Questions = df8["Question"].to_list()
